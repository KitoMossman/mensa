<div class="w3-padding-64 w3-content w3-text-grey" id="impressum">
  ...
  <div class="w3-section">
    ...
    <p><i class="fa fa-user-o fa-fw w3-text-white w3-xxlarge w3-margin-right"> </i>Änderungen: Ingo Weber (Kito Mossman), Tim Opitz, Kerstin Krupp (Gruppe ITSE2501, FIS2507 und ITSE2507)</p>
    <p><i class="fa fa-user fa-fw w3-text-white w3-xxlarge w3-margin-right"> </i>Entwickler: Dennis Schmidt in Zusammenarbeit mit Robert Grunewald und Phillipp Ranft (Gruppe ITSE2107 und ITSE2101)</p>
