...
$sidebarHtml = '
  ...
  <a href="./abrufen.php" class="w3-bar-item w3-button w3-padding-large">
...
$navbarSmallHtml = '
    ...
    <a href="./abrufen.php" class="w3-bar-item w3-button" style="width:20% !important">ANTWORT</a>
    ...
    <div class="modern-card">
      <div class="w3-responsive">
        ...
        foreach ($tage as $tag) {
            ...
            echo "<td class='col-vk'>" . h($vollkost) . "</td>";
            echo "<td class='col-lvk'>" . h($leichteVollkost) . "</td>";
            echo "<td class='col-veg'>" . h($vegetarisch) . "</td>";
            echo "</tr>";
        }
        ?>
        </table>
